...
public class WebSocketBoxServer {
    ...
    protected static CopyOnWriteArraySet<WebSocketBoxServer> webSocketSet = new CopyOnWriteArraySet<WebSocketBoxServer>();
    ...
    public void onOpen(Session session,@PathParam("sid") String sid) {
        ...
        log.info("WebSocketBoxServer有一连接开启！当前在线人数为" + getOnlineCount());
        this.sid=sid;
    }
